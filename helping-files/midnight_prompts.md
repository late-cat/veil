###This file is provided by the Midnight organization/authority as a reference and guidance resource for students building projects with the help of AI agents.

Its purpose is to help ensure that an AI-assisted project is built correctly, completely, and according to the expected Midnight standards. The files contain various checklists, setup instructions, development guidelines, and other requirements that should be followed throughout the project-building process.

Since the project is intended to be built with the assistance of an AI agent, these instructions are especially useful for guiding the agent and reducing the chances of missing important requirements or implementation details.

Therefore, these files should be treated as the standard reference and baseline instructions when building a Midnight project. Following them properly should help produce a more complete, reliable, and submission-ready project.
